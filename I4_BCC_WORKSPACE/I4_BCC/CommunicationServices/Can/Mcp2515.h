...
/* Functions */
EXTERN bool MCP2515_Initialize(void);
EXTERN bool MCP2515_SetConfigMode(void);
EXTERN bool MCP2515_SetNormalMode(void);
EXTERN void MCP2515_Reset(void);
EXTERN uint8_t MCP2515_ReadByte (uint8_t address);
EXTERN void MCP2515_ReadRxSequence(uint8_t instruction, uint8_t *data, uint8_t length);
EXTERN void MCP2515_WriteByte(uint8_t address, uint8_t data);
EXTERN void MCP2515_WriteByteSequence(uint8_t startAddress, uint8_t endAddress, uint8_t *data);
EXTERN void MCP2515_LoadTxSequence(uint8_t instruction, uint8_t *idReg, uint8_t dlc, uint8_t *data);
EXTERN void MCP2515_LoadTxBuffer(uint8_t instruction, uint8_t data);
EXTERN void MCP2515_RequestToSend(uint8_t instruction);
EXTERN uint8_t MCP2515_ReadStatus(void);
EXTERN uint8_t MCP2515_GetRxStatus(void);
EXTERN void MCP2515_BitModify(uint8_t address, uint8_t mask, uint8_t data);
