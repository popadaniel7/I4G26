...
VOID HAL_UART_ErrorCallback(UART_HandleTypeDef *huart)
{
	...
	switch(receivedValue)
	{
		...
		case HAL_UART_ERROR_PE:
			SystemManager_Fault[UART_ERROR_PE] = UART_ERROR_PE;
			break;
		case HAL_UART_ERROR_NE:
			SystemManager_Fault[UART_ERROR_NE] = UART_ERROR_NE;
			break;
		case HAL_UART_ERROR_FE:
			SystemManager_Fault[UART_ERROR_FE] = UART_ERROR_FE;
			break;
		case HAL_UART_ERROR_ORE:
			SystemManager_Fault[UART_ERROR_ORE] = UART_ERROR_ORE;
			break;
