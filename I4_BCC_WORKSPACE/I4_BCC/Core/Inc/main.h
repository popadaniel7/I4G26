...
#define RTS_F_GPIO_Port GPIOC
#define AQS_Pin GPIO_PIN_2
...
#define RPL_L_Pin GPIO_PIN_6
#define RPL_L_GPIO_Port GPIOA
#define RPL_R_Pin GPIO_PIN_7
#define RPL_R_GPIO_Port GPIOA
#define LTS_R_Pin GPIO_PIN_4
#define LTS_R_GPIO_Port GPIOC
#define LTS_F_Pin GPIO_PIN_5
#define LTS_F_GPIO_Port GPIOC
#define BL_R_Pin GPIO_PIN_0
#define BL_R_GPIO_Port GPIOB
#define BL_L_Pin GPIO_PIN_1
