...
MemoryServices/Fee/%.o MemoryServices/Fee/%.su MemoryServices/Fee/%.cyclo: ../MemoryServices/Fee/%.c MemoryServices/Fee/subdir.mk
...
clean-MemoryServices-2f-Fee:
	-$(RM) ./MemoryServices/Fee/Fee.cyclo ./MemoryServices/Fee/Fee.d ./MemoryServices/Fee/Fee.o ./MemoryServices/Fee/Fee.su
